...
public class publishRestResponseTemplate {
    ...
    private List<RecordspublishRest> records;
	...
	public List<RecordspublishRest> getRecords() {
		return records;
	}

	public void setRecords(List<RecordspublishRest> records) {
