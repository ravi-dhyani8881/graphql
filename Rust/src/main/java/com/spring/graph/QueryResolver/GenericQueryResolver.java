...
public class GenericQueryResolver {
	...
	RestTemplate restTemplate;
			...
			public ravimeResponseTemplate  findravimeByQuery(String query, String start,  String rows, String filterField,  String filterQuery,  String sort, String  advanceField,  String advanceQuery,  String advance, String field) {	
		    ...
		    ParameterizedTypeReference<ravimeResponseTemplate> responseType =
	                new ParameterizedTypeReference<ravimeResponseTemplate>() {};

			var response2=restTemplate.exchange(url,HttpMethod.GET, entity, responseType).getBody();
			return (ravimeResponseTemplate) response2;
		}
