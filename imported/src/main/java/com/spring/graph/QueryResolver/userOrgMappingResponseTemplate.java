...
public class userOrgMappingResponseTemplate {
    ...
    private List<RecordsuserOrgMapping> records;
	...
	public List<RecordsuserOrgMapping> getRecords() {
		return records;
	}

	public void setRecords(List<RecordsuserOrgMapping> records) {
