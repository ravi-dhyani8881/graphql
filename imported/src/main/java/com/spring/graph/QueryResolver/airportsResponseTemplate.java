...
public class airportsResponseTemplate {
    ...
    private List<Recordsairports> records;
	...
	public List<Recordsairports> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsairports> records) {
