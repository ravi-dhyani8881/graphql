...
public class aircraftsResponseTemplate {
    ...
    private List<Recordsaircrafts> records;
	...
	public List<Recordsaircrafts> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsaircrafts> records) {
