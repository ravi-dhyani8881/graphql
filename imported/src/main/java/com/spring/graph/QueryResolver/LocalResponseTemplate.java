...
public class LocalResponseTemplate {
    ...
    private List<RecordsLocal> records;
	...
	public List<RecordsLocal> getRecords() {
		return records;
	}

	public void setRecords(List<RecordsLocal> records) {
