...
public class flight_crewResponseTemplate {
    ...
    private List<Recordsflight_crew> records;
	...
	public List<Recordsflight_crew> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsflight_crew> records) {
