...
public class airlinesResponseTemplate {
    ...
    private List<Recordsairlines> records;
	...
	public List<Recordsairlines> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsairlines> records) {
