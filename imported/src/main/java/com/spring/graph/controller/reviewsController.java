...
public class reviewsController {
	...
	@QueryMapping
    public reviewsResponseTemplate findreviewsByQuery(@Argument String query, @Argument String start,@Argument String rows, @Argument String filterField, @Argument String filterQuery,
