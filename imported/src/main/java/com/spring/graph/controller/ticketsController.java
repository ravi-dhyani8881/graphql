...
import com.spring.graph.Model.Recordstickets;
...
public class ticketsController {
	...
	@QueryMapping
    public ticketsResponseTemplate findticketsByQuery(@Argument String query, @Argument String start,@Argument String rows, @Argument String filterField, @Argument String filterQuery,
    							  @Argument String sort,@Argument String advanceField,@Argument String advanceQuery,@Argument String advance) {
		return  genericQueryResolver.findticketsByQuery(query, start, rows, filterField, filterQuery, sort, advanceField, advanceQuery, advance);	
    }
	  
  @SchemaMapping
  public bookingsResponseTemplate findbookingsByQuery(
    Recordstickets content,
