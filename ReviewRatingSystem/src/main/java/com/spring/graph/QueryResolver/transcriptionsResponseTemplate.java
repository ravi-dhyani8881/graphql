...
public class transcriptionsResponseTemplate {
    ...
    private List<Recordstranscriptions> records;
	...
	public List<Recordstranscriptions> getRecords() {
		return records;
	}

	public void setRecords(List<Recordstranscriptions> records) {
