...
public class borrowingsResponseTemplate {
    ...
    private List<Recordsborrowings> records;
	...
	public List<Recordsborrowings> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsborrowings> records) {
