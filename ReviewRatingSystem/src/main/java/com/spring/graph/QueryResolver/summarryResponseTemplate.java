...
public class summarryResponseTemplate {
    ...
    private List<Recordssummarry> records;
	...
	public List<Recordssummarry> getRecords() {
		return records;
	}

	public void setRecords(List<Recordssummarry> records) {
