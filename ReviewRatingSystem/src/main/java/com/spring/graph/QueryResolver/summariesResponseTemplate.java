...
public class summariesResponseTemplate {
    ...
    private List<Recordssummaries> records;
	...
	public List<Recordssummaries> getRecords() {
		return records;
	}

	public void setRecords(List<Recordssummaries> records) {
