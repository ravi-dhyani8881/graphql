...
public class action_itemsResponseTemplate {
    ...
    private List<Recordsaction_items> records;
	...
	public List<Recordsaction_items> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsaction_items> records) {
