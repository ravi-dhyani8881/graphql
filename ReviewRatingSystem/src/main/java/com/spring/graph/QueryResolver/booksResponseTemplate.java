...
public class booksResponseTemplate {
    ...
    private List<Recordsbooks> records;
	...
	public List<Recordsbooks> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsbooks> records) {
