...
public class publishGraphController {
	...
	@QueryMapping
    public publishGraphResponseTemplate findpublishGraphByQuery(@Argument String query, @Argument String start,@Argument String rows, @Argument String filterField, @Argument List<String> filterQuery,
