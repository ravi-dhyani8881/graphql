...
public class projectResponseTemplate {
    ...
    private List<Recordsproject> records;
	...
	public List<Recordsproject> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsproject> records) {
