...
public class publishLogResponseTemplate {
    ...
    private List<RecordspublishLog> records;
	...
	public List<RecordspublishLog> getRecords() {
		return records;
	}

	public void setRecords(List<RecordspublishLog> records) {
