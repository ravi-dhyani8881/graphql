...
public class subOrganizationResponseTemplate {
    ...
    private List<RecordssubOrganization> records;
	...
	public List<RecordssubOrganization> getRecords() {
		return records;
	}

	public void setRecords(List<RecordssubOrganization> records) {
