...
public class secondResponseTemplate {
    ...
    private List<Recordssecond> records;
	...
	public List<Recordssecond> getRecords() {
		return records;
	}

	public void setRecords(List<Recordssecond> records) {
