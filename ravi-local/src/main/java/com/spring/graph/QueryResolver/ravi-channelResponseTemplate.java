...
public class ravi-channelResponseTemplate {
    ...
    private List<Recordsravi-channel> records;
	...
	public List<Recordsravi-channel> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsravi-channel> records) {
