...
public class dhyaniResponseTemplate {
    ...
    private List<Recordsdhyani> records;
	...
	public List<Recordsdhyani> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsdhyani> records) {
