...
public class ratingsResponseTemplate {
    ...
    private List<Recordsratings> records;
	...
	public List<Recordsratings> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsratings> records) {
