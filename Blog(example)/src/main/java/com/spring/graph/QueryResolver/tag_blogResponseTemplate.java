...
public class tag_blogResponseTemplate {
    ...
    private List<Recordstag_blog> records;
	...
	public List<Recordstag_blog> getRecords() {
		return records;
	}

	public void setRecords(List<Recordstag_blog> records) {
