...
public class blogsResponseTemplate {
    ...
    private List<Recordsblogs> records;
	...
	public List<Recordsblogs> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsblogs> records) {
