...
public class graphVersionsResponseTemplate {
    ...
    private List<RecordsgraphVersions> records;
	...
	public List<RecordsgraphVersions> getRecords() {
		return records;
	}

	public void setRecords(List<RecordsgraphVersions> records) {
