...
public class graphDeploymentsResponseTemplate {
    ...
    private List<RecordsgraphDeployments> records;
	...
	public List<RecordsgraphDeployments> getRecords() {
		return records;
	}

	public void setRecords(List<RecordsgraphDeployments> records) {
