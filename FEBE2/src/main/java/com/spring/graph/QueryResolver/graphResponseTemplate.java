...
public class graphResponseTemplate {
    ...
    private List<Recordsgraph> records;
	...
	public List<Recordsgraph> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsgraph> records) {
