...
import com.spring.graph.Model.Recordsgraph_versions;
...
@Controller
public class graph_versionsController {

	@Autowired
	GenericQueryResolver genericQueryResolver;
	
	@QueryMapping
    public graph_versionsResponseTemplate findgraph_versionsByQuery(@Argument String query, @Argument String start,@Argument String rows, @Argument String filterField, @Argument String filterQuery,
		...
		return  genericQueryResolver.findgraph_versionsByQuery(query, start, rows, filterField, filterQuery, sort, advanceField, advanceQuery, advance, field);	
    }
	  
  @SchemaMapping
  public graphResponseTemplate findgraphByQuery(
    Recordsgraph_versions content,
