...
public class GenericQueryResolver {
	...
	RestTemplate restTemplate;
			...
			public ravimemResponseTemplate  findravimemByQuery(String query, String start,  String rows, String filterField,  String filterQuery,  String sort, String  advanceField,  String advanceQuery,  String advance, String field) {	
		    ...
		    ParameterizedTypeReference<ravimemResponseTemplate> responseType =
	                new ParameterizedTypeReference<ravimemResponseTemplate>() {};

			var response2=restTemplate.exchange(url,HttpMethod.GET, entity, responseType).getBody();
			return (ravimemResponseTemplate) response2;
		}
