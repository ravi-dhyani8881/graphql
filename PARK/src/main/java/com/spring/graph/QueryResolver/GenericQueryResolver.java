...
public class GenericQueryResolver {
	...
	RestTemplate restTemplate;
		...
		//	String url="http://rest-service-66948276-7d92-476d-8cf8-1ebc5c8aafbe:80/"+toPascalCase("orders")+"/findByQuery?query="+query+"&start="+start+"&rows="+rows+"&filterField="+filterField+"&filterQuery="+filterQuery+"&sort="+sort+"&advanceField="+advanceField+"&advanceQuery="+advanceQuery+"&advance="+advance;
		...
		//	String url="http://rest-service-66948276-7d92-476d-8cf8-1ebc5c8aafbe:80/"+toPascalCase("user")+"/findByQuery?query="+query+"&start="+start+"&rows="+rows+"&filterField="+filterField+"&filterQuery="+filterQuery+"&sort="+sort+"&advanceField="+advanceField+"&advanceQuery="+advanceQuery+"&advance="+advance;
		...
		//	String url="http://rest-service-66948276-7d92-476d-8cf8-1ebc5c8aafbe:80/"+toPascalCase("supply")+"/findByQuery?query="+query+"&start="+start+"&rows="+rows+"&filterField="+filterField+"&filterQuery="+filterQuery+"&sort="+sort+"&advanceField="+advanceField+"&advanceQuery="+advanceQuery+"&advance="+advance;
