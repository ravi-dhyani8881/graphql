...
import com.spring.graph.Model.RecordsgraphStatus;
...
public class graphStatusController {
	...
	@QueryMapping
    public graphStatusResponseTemplate findgraphStatusByQuery(@Argument String query, @Argument String start,@Argument String rows, @Argument String filterField, @Argument String filterQuery,
		...
		return  genericQueryResolver.findgraphStatusByQuery(query, start, rows, filterField, filterQuery, sort, advanceField, advanceQuery, advance, field);	
    }
	  
  @SchemaMapping
  public graphResponseTemplate findgraphByQuery(
    RecordsgraphStatus content,
