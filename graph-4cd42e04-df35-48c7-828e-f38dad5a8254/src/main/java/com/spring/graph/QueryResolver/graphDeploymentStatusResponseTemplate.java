...
public class graphDeploymentStatusResponseTemplate {
    ...
    private List<RecordsgraphDeploymentStatus> records;
	...
	public List<RecordsgraphDeploymentStatus> getRecords() {
		return records;
	}

	public void setRecords(List<RecordsgraphDeploymentStatus> records) {
