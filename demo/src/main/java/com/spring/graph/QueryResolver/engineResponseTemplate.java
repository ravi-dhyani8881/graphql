...
public class engineResponseTemplate {
    ...
    private List<Recordsengine> records;
	...
	public List<Recordsengine> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsengine> records) {
