...
public class profilesResponseTemplate {
    ...
    private List<Recordsprofiles> records;
	...
	public List<Recordsprofiles> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsprofiles> records) {
