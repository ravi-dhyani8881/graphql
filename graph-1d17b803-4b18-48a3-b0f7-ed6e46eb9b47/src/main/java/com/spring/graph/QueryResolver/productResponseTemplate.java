...
public class productResponseTemplate {
    ...
    private List<Recordsproduct> records;
	...
	public List<Recordsproduct> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsproduct> records) {
