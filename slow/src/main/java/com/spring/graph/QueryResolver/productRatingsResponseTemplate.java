...
public class productRatingsResponseTemplate {
    ...
    private List<RecordsproductRatings> records;
	...
	public List<RecordsproductRatings> getRecords() {
		return records;
	}

	public void setRecords(List<RecordsproductRatings> records) {
