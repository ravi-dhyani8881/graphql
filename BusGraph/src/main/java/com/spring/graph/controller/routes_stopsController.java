...
public class routes_stopsController {
	...
	@QueryMapping
    public routes_stopsResponseTemplate findroutes_stopsByQuery(@Argument String query, @Argument String start,@Argument String rows, @Argument String filterField, @Argument String filterQuery,
