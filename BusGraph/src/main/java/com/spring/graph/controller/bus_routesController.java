...
public class bus_routesController {
	...
	@QueryMapping
    public bus_routesResponseTemplate findbus_routesByQuery(@Argument String query, @Argument String start,@Argument String rows, @Argument String filterField, @Argument String filterQuery,
