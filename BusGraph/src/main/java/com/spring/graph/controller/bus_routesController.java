...
import com.spring.graph.Model.Recordsbus_routes;
  import com.spring.graph.QueryResolver.routes_stopsResponseTemplate;


@Controller
public class bus_routesController {

	@Autowired
	GenericQueryResolver genericQueryResolver;
	
	@QueryMapping
    public bus_routesResponseTemplate findbus_routesByQuery(@Argument String query, @Argument String start,@Argument String rows, @Argument String filterField, @Argument List<String> filterQuery,
    							  @Argument String sort,@Argument String advanceField,@Argument String advanceQuery,@Argument String advance) {
		return  genericQueryResolver.findbus_routesByQuery(query, start, rows, filterField, filterQuery, sort, advanceField, advanceQuery, advance);	
    }
	  
  @SchemaMapping
  public routes_stopsResponseTemplate findroutes_stopsByQuery(
    Recordsbus_routes content,
