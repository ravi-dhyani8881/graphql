...
public class routes_stopsResponseTemplate {
    ...
    private List<Recordsroutes_stops> records;
	...
	public List<Recordsroutes_stops> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsroutes_stops> records) {
