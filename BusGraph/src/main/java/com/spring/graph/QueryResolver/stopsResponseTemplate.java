...
public class stopsResponseTemplate {
    ...
    private List<Recordsstops> records;
	...
	public List<Recordsstops> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsstops> records) {
