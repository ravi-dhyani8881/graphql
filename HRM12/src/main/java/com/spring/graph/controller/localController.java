...
public class localController {
  ...
  @SchemaMapping
  public local2ResponseTemplate findlocal2ByQuery(
    ...
    return genericQueryResolver.findlocal2ByQuery(query2, start, rows, filterField, filterQuery, sort, advanceField, advanceQuery, advance);
  }
