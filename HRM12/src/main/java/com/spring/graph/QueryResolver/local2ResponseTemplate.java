...
public class local2ResponseTemplate {
    ...
    private List<Recordslocal2> records;
	...
	public List<Recordslocal2> getRecords() {
		return records;
	}

	public void setRecords(List<Recordslocal2> records) {
