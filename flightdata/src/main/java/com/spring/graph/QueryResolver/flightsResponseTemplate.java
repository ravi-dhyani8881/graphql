...
public class flightsResponseTemplate {
    ...
    private List<Recordsflights> records;
	...
	public List<Recordsflights> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsflights> records) {
