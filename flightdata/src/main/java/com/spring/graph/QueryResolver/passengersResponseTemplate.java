...
public class passengersResponseTemplate {
    ...
    private List<Recordspassengers> records;
	...
	public List<Recordspassengers> getRecords() {
		return records;
	}

	public void setRecords(List<Recordspassengers> records) {
