...
public class crew_membersResponseTemplate {
    ...
    private List<Recordscrew_members> records;
	...
	public List<Recordscrew_members> getRecords() {
		return records;
	}

	public void setRecords(List<Recordscrew_members> records) {
