...
public class bookingsResponseTemplate {
    ...
    private List<Recordsbookings> records;
	...
	public List<Recordsbookings> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsbookings> records) {
