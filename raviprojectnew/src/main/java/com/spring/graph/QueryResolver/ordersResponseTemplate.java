...
public class ordersResponseTemplate {
    ...
    private List<Recordsorders> records;
	...
	public List<Recordsorders> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsorders> records) {
