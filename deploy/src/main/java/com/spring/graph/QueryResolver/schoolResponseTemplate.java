...
public class schoolResponseTemplate {
    ...
    private List<Recordsschool> records;
	...
	public List<Recordsschool> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsschool> records) {
