...
public class land3ResponseTemplate {
    ...
    private List<Recordsland3> records;
	...
	public List<Recordsland3> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsland3> records) {
