...
import com.spring.graph.Model.Recordspurchases;
...
public class purchasesController {
	...
	@QueryMapping
    public purchasesResponseTemplate findpurchasesByQuery(@Argument String query, @Argument String start,@Argument String rows, @Argument String filterField, @Argument List<String> filterQuery,
    							  @Argument String sort,@Argument String advanceField,@Argument String advanceQuery,@Argument String advance) {
		return  genericQueryResolver.findpurchasesByQuery(query, start, rows, filterField, filterQuery, sort, advanceField, advanceQuery, advance);	
    }
	  
  @SchemaMapping
  public productsResponseTemplate findproductsByQuery(
    Recordspurchases content,
