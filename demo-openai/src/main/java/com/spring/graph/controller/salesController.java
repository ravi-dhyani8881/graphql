...
import com.spring.graph.Model.Recordssales;
...
public class salesController {
	...
	@QueryMapping
    public salesResponseTemplate findsalesByQuery(@Argument String query, @Argument String start,@Argument String rows, @Argument String filterField, @Argument List<String> filterQuery,
    							  @Argument String sort,@Argument String advanceField,@Argument String advanceQuery,@Argument String advance) {
		return  genericQueryResolver.findsalesByQuery(query, start, rows, filterField, filterQuery, sort, advanceField, advanceQuery, advance);	
    }
	  
  @SchemaMapping
  public productsResponseTemplate findproductsByQuery(
    Recordssales content,
