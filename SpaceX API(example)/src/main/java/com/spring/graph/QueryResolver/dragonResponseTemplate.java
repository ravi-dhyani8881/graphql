...
public class dragonResponseTemplate {
    ...
    private List<Recordsdragon> records;
	...
	public List<Recordsdragon> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsdragon> records) {
