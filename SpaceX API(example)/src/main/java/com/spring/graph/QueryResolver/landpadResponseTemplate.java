...
public class landpadResponseTemplate {
    ...
    private List<Recordslandpad> records;
	...
	public List<Recordslandpad> getRecords() {
		return records;
	}

	public void setRecords(List<Recordslandpad> records) {
