...
public class capsuleResponseTemplate {
    ...
    private List<Recordscapsule> records;
	...
	public List<Recordscapsule> getRecords() {
		return records;
	}

	public void setRecords(List<Recordscapsule> records) {
