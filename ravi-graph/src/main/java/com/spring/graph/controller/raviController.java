...
public class raviController {
    ...
    public raviResponseTemplate findraviByQuery(@Argument String query, @Argument String start,@Argument String rows, @Argument String filterField, @Argument String filterQuery,
		...
		return  genericQueryResolver.findraviByQuery(query, start, rows, filterField, filterQuery, sort, advanceField, advanceQuery, advance, field);	
    }
	  
			@SchemaMapping
			public raviResponseTemplate findraviByQuery(Recordsravi content, @Argument String query, @Argument String start,@Argument String rows,
