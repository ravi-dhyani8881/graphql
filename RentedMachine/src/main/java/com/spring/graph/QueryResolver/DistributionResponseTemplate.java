...
public class DistributionResponseTemplate {
    ...
    private List<RecordsDistribution> records;
	...
	public List<RecordsDistribution> getRecords() {
		return records;
	}

	public void setRecords(List<RecordsDistribution> records) {
