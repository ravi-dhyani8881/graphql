...
public class venderResponseTemplate {
    ...
    private List<Recordsvender> records;
	...
	public List<Recordsvender> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsvender> records) {
