...
public class headsheetResponseTemplate {
    ...
    private List<Recordsheadsheet> records;
	...
	public List<Recordsheadsheet> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsheadsheet> records) {
