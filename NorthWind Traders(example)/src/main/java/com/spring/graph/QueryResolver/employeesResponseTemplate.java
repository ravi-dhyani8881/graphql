...
public class employeesResponseTemplate {
    ...
    private List<Recordsemployees> records;
	...
	public List<Recordsemployees> getRecords() {
		return records;
	}

	public void setRecords(List<Recordsemployees> records) {
