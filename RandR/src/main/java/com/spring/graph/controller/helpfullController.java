...
import com.spring.graph.Model.Recordshelpfull;
...
public class helpfullController {
	...
	@QueryMapping
    public helpfullResponseTemplate findhelpfullByQuery(@Argument String query, @Argument String start,@Argument String rows, @Argument String filterField, @Argument List<String> filterQuery,
    ...
    return  genericQueryResolver.findhelpfullByQuery(query, start, rows, filterField, filterQuery, sort, advanceField, advanceQuery, advance, token);	
    }
	  
  @SchemaMapping
  public userResponseTemplate finduserByQuery(
    Recordshelpfull content,
