...
import com.spring.graph.Model.Recordslike;
...
public class likeController {
	...
	@QueryMapping
    public likeResponseTemplate findlikeByQuery(@Argument String query, @Argument String start,@Argument String rows, @Argument String filterField, @Argument List<String> filterQuery,
    ...
    return  genericQueryResolver.findlikeByQuery(query, start, rows, filterField, filterQuery, sort, advanceField, advanceQuery, advance, token);	
    }
