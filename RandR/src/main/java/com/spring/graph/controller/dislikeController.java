...
import com.spring.graph.Model.Recordsdislike;
...
public class dislikeController {
	...
	@QueryMapping
    public dislikeResponseTemplate finddislikeByQuery(@Argument String query, @Argument String start,@Argument String rows, @Argument String filterField, @Argument List<String> filterQuery,
    ...
    return  genericQueryResolver.finddislikeByQuery(query, start, rows, filterField, filterQuery, sort, advanceField, advanceQuery, advance, token);	
    }
	  
  @SchemaMapping
  public reviewResponseTemplate findreviewByQuery(
    Recordsdislike content,
